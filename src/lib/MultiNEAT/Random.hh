...
public:
  ...
  // Returns a random number from a uniform distribution in the range of [0 ..
  // 1]
  double RandFloat();

  // Returns a random number from a uniform distribution in the range of [-1 ..
  // 1]
  double RandFloatSigned();

  // Returns a random number from a gaussian (normal) distribution in the range
  // of [-1 .. 1]
