...
public:
  ...
  // Constructors
  ////////////////////////////
  Innovation(int a_ID, InnovationType a_InnovType, int a_From, int a_To,
             NeuronType a_NType, int a_NID) {
    m_ID = a_ID;
...
public:
  ...
  // Creates an empty database but this time sets the next innov number and
  // neuron ID
  ...
  std::vector<int> CheckAllInnovations(int a_In, int a_Out,
