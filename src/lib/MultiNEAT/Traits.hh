...
public:
  ...
  std::string
      type; // can be "int", "float", "string", "intset", "floatset", "pyobject"
  bs::variant<IntTraitParameters, FloatTraitParameters, StringTraitParameters,
              IntSetTraitParameters, FloatSetTraitParameters>
      m_Details;
