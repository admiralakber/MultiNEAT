...
public:
  ...
  // returns the leader (the member having the best fitness, representing the
  // species)
  ...
  // applies extreme penalty for stagnating species over SpeciesDropoffAge
  // generations.
  ...
  void MutateGenome(bool t_baby_is_clone, Population &a_Pop, Genome &t_baby,
                    Parameters &a_Parameters, RNG &a_RNG);
