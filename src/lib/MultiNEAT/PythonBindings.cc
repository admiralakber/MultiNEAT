...
///////////////////////////////////////////////////////////////////
    ...
    class_<NeuralNetwork>("NeuralNetwork", init<>())
            ...
            .def("GetTotalConnectionLeng.hh", &NeuralNetwork::GetTotalConnectionLength)
...
///////////////////////////////////////////////////////////////////
    ...
    class_<Genome, Genome*>("Genome", init<>())
            ...
            .def("GetDep.hh", &Genome::GetDepth)
            .def("CalculateDep.hh", &Genome::CalculateDepth)
...
///////////////////////////////////////////////////////////////////
    ...
    class_<Parameters>("Parameters", init<>())
            ...
            .def_readwrite("KillWorstSpeciesEa.hh", &Parameters::KillWorstSpeciesEach)
            ...
            .def_readwrite("NoveltySearch_Recompute_Sparseness_Ea.hh", &Parameters::NoveltySearch_Recompute_Sparseness_Each)
            ...
            .def_readwrite("InitialDep.hh", &Parameters::InitialDepth)
            .def_readwrite("MaxDep.hh", &Parameters::MaxDepth)
            .def_readwrite("CPPN_Bias", &Parameters::CPPN_Bias)
            .def_readwrite("Wid.hh", &Parameters::Width)
